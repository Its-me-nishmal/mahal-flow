# ⚡ 09 - Performance & Load Testing Benchmarks
...
| :--- | :--- | :--- | :--- | :--- |
| **1. Concurrent Reads** | 100 Workers | **100.0%** (100/100) | p50: 267ms / p95: 321ms / p99: 356ms | Pass |
| **2. Concurrent Payments** | 20 Workers | **100.0%** (20/20) | p50: 88ms / p95: 96ms / p99: 96ms | Pass (100% Atomic) |

...
I would **not put backend behavior into `design.md`**.

For example:

- "Refund returns obligations to PENDING" → `03-business-rules.md`
- "Webhook must be idempotent" → `06-payment-system.md`
- "Button is green and says Confirm Refund" → `21-design.md`

That separation will make Stitch + coding agents much more reliable.